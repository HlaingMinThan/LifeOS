...
class ModelsTest extends TestCase
{
    ...
    {
        LedgerEntry::factory()->create(['direction' => 'payable', 'status' => 'open']);
        LedgerEntry::factory()->paid()->create(['direction' => 'payable']);
        LedgerEntry::factory()->create(['direction' => 'receivable', 'status' => 'open']);
    ...
    {
        Todo::factory()->create(['due_date' => today()->subDay()]);
        Todo::factory()->create(['due_date' => today()->addDay()]);
        Todo::factory()->done()->create(['due_date' => today()->subDay()]);
    ...
    {
        $task = CareTask::factory()->create(['time_of_day' => '07:30:00']);
